<template>
    <div class="mid">
      <div class="mid-map" id="charts_map"></div>
    </div>
</template>
<script>
export default {
  ...
  mounted() {
    ...
    var shangxi = 'data-shangxi'
    var shanghai = 'data-shanghai'
    var shangdong = 'data-shangdong'
    ...
    var chongqing = 'data-chongqing'
    var aomen = 'data-aomen'
    var anhui = 'data-anhui'
    var beijing = 'data-beijing'
    var fujian = 'data-fujian'
    var xianggang = 'data-xianggang'
    this.$echarts.extendsMap = function(id, opt) {
      ...
      chart.on('click', function(params) {
        ...
        if (opt.goDown && params.name !== name[idx]) {
          if (cityMap[params.name]) {
            ...
            let jsonData1 = require(`@/assets/map/${url}.json`)
            curGeoJson = jsonData1
            this.$echarts.registerMap(params.name, jsonData1)
      ...
      chart.setMap = function(mapName) {
        ...
        if (citySource) {
          ...
          let jsonData2 = require(`@/assets/map/${citySource}.json`)
          // fetch(url).then(function(response) {
          // console.log(response);
          curGeoJson = jsonData2
          this.$echarts.registerMap(mapName, jsonData2)
    ...
    let jsonData = require(`@/assets/map/data-china.json`)
    // fetch(zhongguo).then(function(geoJson) {
    this.$echarts.registerMap('中国', jsonData)
    var myChart = this.$echarts.extendsMap('charts_map', {
